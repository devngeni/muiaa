...
import { StyledOrderTrackCardTitleSubWrapper, StyledOrderTrackCardTitleMainWrapper, StyledPersonInfoWrapper, StyledTrackOrderCardContainer, StyledNotStartedContainer, StyledOrderTrackDescTypography, StyledTimestampTypography } from '@/styles/overViewPageStyles';
...
const OrderTrackCard=({
  ...
  return (
    <>
   {status=="started" && <StyledTrackOrderCardContainer>
      <StyledOrderTrackCardTitleMainWrapper>
        <StyledOrderTrackCardTitleSubWrapper>
          <Typography variant='h5'>Packed</Typography>
          <Typography variant='body2'>•</Typography>
          <StyledTimestampTypography variant='body1'>{timeStamp}</StyledTimestampTypography>
        </StyledOrderTrackCardTitleSubWrapper>
        <Checked/>
      </StyledOrderTrackCardTitleMainWrapper>
      <StyledOrderTrackDescTypography variant='body1'>{desc} </StyledOrderTrackDescTypography>
